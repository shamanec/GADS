...
To setup the file for the provider, download the Selenium server jar [release](https://github.com/SeleniumHQ/selenium/releases/tag/selenium-4.13.0) v4.13 and upload it to Mongo via the hub admin UI.  
